    ...
    <div className="min-h-screen bg-gradient-to-br from-brand-1 via-brand-2 to-brand-3 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold text-neutral-700">Welcome Back!</h1>
          <p className="text-brand-1">Sign in to continue your learning journey</p>
        </div>

        <Card className="shadow-2xl border-0">
          <CardHeader className="space-y-1">
            <CardTitle className="text-2xl font-bold text-center text-brand-5">Sign In</CardTitle>
          ...
          <CardContent className="space-y-4">
            <form className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <Link href="/forgot-password" className="text-sm text-brand-1 hover:text-brand-2 font-medium">
                  Forgot password?
                </Link>
              </div>
              <Button
            ...
            <div className="text-center text-sm text-muted-foreground">
              ...
              <Link href="/signup" className="text-brand-1 hover:text-brand-2 font-medium">
                Sign up here
              </Link>
            </div>
          </CardContent>
